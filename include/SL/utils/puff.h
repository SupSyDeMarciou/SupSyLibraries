...
#else
#   include "inout.h"
int puff(unsigned char *dest, unsigned long *destlen, const unsigned char *source, unsigned long *sourcelen) { SL_throwError("PNG format has been deactivated!"); return 0; }
#endif